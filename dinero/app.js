...
function renderizarDashboard() {
  ...
  // Balance = suma histórica de todos los movimientos
  // Las cuentas son solo una vista del dinero, no cambian el balance total
  const balance = movimientosCache.reduce(
